...
description: 'Guide on how to install and setup Senyumku UI Web in your project.'
---

Senyumku UI Web can be installed via **package managers** like `yarn` or `npm`.
...
Upon installation, `@senyumku-ui-web/core` and all its underlying packages will be accessible from
...
```scss
@import '@senyumku-ui-web/core';
// or
@import '@senyumku-ui-web/core/index.scss';
```

If you would like to use individual packages/modules, you can import them directly using the
`@senyumku-ui-web/<package-name>/<package-name>.scss` format. For example:

```scss
@import '@senyumku-ui-web/color/color.scss';
@import '@senyumku-ui-web/typography/typography.scss';
```
...
```scss
@import '@senyumku-ui-web/color/scss';
@import '@senyumku-ui-web/typography/scss';
@import '@senyumku-ui-web/shape/scss';
// or
@import '@senyumku-ui-web/color/scss/index.scss';
@import '@senyumku-ui-web/typography/scss';
@import '@senyumku-ui-web/shape/scss';
```
