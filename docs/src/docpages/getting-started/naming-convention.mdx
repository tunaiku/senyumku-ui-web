...
Senyumku UI's naming conventions are highly influenced from SUIT CSS and is adapted from them. It
relies on structured class names and meaningful hyphens (i.e., not using hyphens merely to separate
words).
